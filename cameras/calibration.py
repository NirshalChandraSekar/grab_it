...
class CalibrateCameras:
    ...
    def calibrate_cameras(self, camera_serials=None, saved_path="cameras/calibration_images"):
        """
        ...
        frames_data = {}
        for frame_num in range(30):  # Assuming 10 frames as in save_frames_for_calibration
